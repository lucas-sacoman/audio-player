...
export default {
   get() {
      ...
      this.playNext = document.querySelector("#skip-next");
      this.playPrevious = document.querySelector("#skip-previous");
   },
   ...
   actions() {
      ...
      this.playNext.onclick = () => this.playNextMusic();
      this.playPrevious.onclick = () => this.playPreviousMusic();
